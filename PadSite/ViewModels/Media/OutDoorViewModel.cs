...
namespace PadSite.ViewModels
{
    public class OutDoorViewModel
    {
        ...
        [CheckContact]
        [HintClass("longtext")]
        [AdditionalMetadata("CascadingIds", "MediaCode,FormatCode")]
        [StringLength(50, ErrorMessage = "请输入{2}-{1}位{0}", MinimumLength = 6)]
        [Hint("6-50个字，不允许填写电话和特殊符号。例：新华书店附近户外大牌")]
        [UIHint("CascadingText")]
        ...
        [Display(Name = "媒体城市")]
        [UIHint("Cascading")]
        [AdditionalMetadata("CascadingLevel", "2")]
    ...
    public class OutDoorAdminViewModel
    {
        public OutDoorAdminViewModel()
        {
            //this.StartTime = DateTime.Now;
            //this.EndTime = DateTime.Now;
            this.Deadline = DateTime.Now;
        ...
        [Display(Name = "所属业主")]
        [Required(ErrorMessage = "请选择所属业主")]
        [UIHint("GridSelectSingle")]
